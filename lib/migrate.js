...
const _filterStateForDifference = function(state) {
    state = JSON.parse(JSON.stringify(state));
    const removeKeys = ['validate'];
...
//    log(JSON.stringify(currentState, null, 4));
    previousState = _filterStateForDifference(previousState);
    currentState = _filterStateForDifference(currentState);
